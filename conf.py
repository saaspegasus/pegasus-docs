...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'README.md', 'venv', '.direnv', 'CLAUDE.md']
...
html_js_files = [
    ("https://unpkg.com/scriv-chat@0.2.0/dist/scriv-chat/scriv-chat.esm.js", {"type": "module"}),
]
