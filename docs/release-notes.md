...
(via ollama). For details on getting started with `litellm` see the updated [AI documentation](ai/llms.md).
...
For complete details, see the new [AI documentation](ai/images.md).
...
You can also connect an existing project to Github by following the [instructions here](github.md#connecting-an-existing-project-to-github).
...
For more details, see the new [Pegasus Kamal documentation](deployment/kamal.md).

Below are the complete release notes:

### Added

- **Added support for deploying to any linux server using the new Kamal deployment option. [Documentation](deployment/kamal.md).**
...
![Admin Dashboard](assets/images/user-dashboard.png)
...
- Overhauled the documentation on working with [virtual environments](python/packages.md) and made
...
- There are no known breaking changes related to the Python and Node upgrades, but it is recommended to upgrade
  ...
  You may need to [rebuild your Python requirements](python/packages.md#working-with-requirements)
...
Pin the Django version to 3.2.x in your requirements file and [rebuild requirements](python/packages.md#working-with-requirements).
...
See the updated [Tailwind docs](css/tailwind.md) for more information and customization options.
...
- Overhauled [CSS docs](css/overview.md).
...
For more information on using APIs in your Pegasus app, see the new [API docs](apis.md).
...
- Added [documentation related to these changes](apis.md).
...
You can learn more about Wagtail and Pegasus in this 5-minute overview, or by heading over to the [Wagtail documentation](wagtail.md).
...
- **Pegasus now supports Wagtail! [Documentation](wagtail.md).** There are a fair number of changes to support this work, most
...
- **Added an `active_subscription_required` decorator for easier subscription feature-gating. [Docs](subscriptions.md#using-the-active_subscription_required-decorator)**
...
- Added [page metadata documentation](page-metadata.md) for working with project / page metadata (e.g. page titles).
- Updated the [upgrading documentation](upgrading.md) to recommend a branch-based approach.
...
See [the documentation](github-actions.md) for more details.

### Added

- [Github Actions support](github-actions.md).
...
This is a very similar issue to the one described in the [0.14.2 release notes](release-notes.md#version-0142).
...
You can get an overview in this 2-minute video or check out [the documentation](apis.md) for details.
...
- API Key support! See the new [API key documentation](apis.md) for details.
...
- Set various production-recommended settings in `settings_heroku.py`.
  For more details see the new [production checklist](deployment/production-checklist.md) in the documentation.
...
More details can be found in the [Teams documentation](teams.md).
...
**Changes affecting [experimental features](experimental/index.md) only:**
...
- Add support for celery workers to Digital Ocean deployments (and [updated docs](deployment/digital-ocean.md))
...
- Add `Makefile` with self-documenting targets for various common operations ([see docs](docker.md))
...
See the new [CSS documentation](css/overview.md) for an overview of the new structure.
...
the Bootstrap CSS framework. Details on using Bootstrap [can be found here](css/bootstrap.md).
...
More details can be found in the [Tailwind documentation](css/tailwind.md).
...
Instructions on upgrading can be found on the ["upgrading" page](upgrading.md).
...
- Remove `package-lock.json` from Pegasus for improved compatibility across NPM / OS versions.
  ...
  More details can be found in the [front end docs](front-end/overview.md).
...
More details can be found in the new [deployment guide](deployment/overview.md).
...
More details can be found in the new [Docker documentation](docker.md).
...
Additional documentation can be found in the [subscription docs](subscriptions.md).
...
Documentation for subscriptions can be [found here](subscriptions.md).
...
- Added [subscriptions overview page](subscriptions.md)
