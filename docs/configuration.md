...
For help configuring LLMs and AIs, see the [AI docs](ai/index.md).

## Celery

See the [celery docs](celery.md) for set up and configuration of Celery.
...
![Turnstile Dev](assets/images/turnstile.png)
...
to add it to your `prod-requirements.in` file and [re-build](python/setup.md) your `prod-requirements.txt` file.
