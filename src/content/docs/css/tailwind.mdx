---
title: Tailwind CSS
description: Build modern UIs with TailwindCSS v4, DaisyUI components, shadcn/ui integration, dark mode themes, and Flowbite styling options.
sidebar:
  order: 4
---
...
Pegasus supports [Tailwind CSS](https://tailwindcss.com/) (Version 4) and it is the recommended CSS framework for all projects.
...
If you're overriding a built-in theme (e.g. "light"), you should also disable DaisyUI's default themes
