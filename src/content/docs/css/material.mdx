...
<Aside type="caution" title="This feature is deprecated">
This theme has been deprecated and is no longer actively maintained.
It is recommended to switch to [Tailwind CSS](/css/tailwind).
</Aside>
