...
![Subscriptions Project configuration](../../assets/images/subscriptions/subscriptions-config.png)
...
1. Update the `STRIPE_*` variables in your project's [`.env` file](/configuration/#settings-and-environment-files)
...
![Subscription Example](../../assets/images/subscription-example.png)
...
![Stripe Confirmation Page](../../assets/images/subscriptions/stripe-confirmation-page.png)
