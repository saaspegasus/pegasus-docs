...
description: Configure Django settings, environment variables, email providers, social authentication, Stripe payments, and production deployments.
---
...
To enable the Kit integration, create your Kit account and go to Settings --> Developer,
and create a new V4 API key.
...
[Django docs](https://docs.djangoproject.com/en/stable/topics/logging/).
...
[default]: https://docs.djangoproject.com/en/stable/topics/files/
