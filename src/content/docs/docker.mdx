...
start all the processes needed to run your application, including Django, the front end server / bundler,
and Celery.
...
This will stop the Database services (PostgreSQL and Redis) and in full-mode,
stop the other container processes (Django, Vite/Webpack, and Celery).
