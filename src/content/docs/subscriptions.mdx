---
title: Subscriptions
description: Implement SaaS subscriptions with Stripe billing, pricing tables, webhooks, customer portals, and per-seat or usage-based pricing models.
---
...
If you are on version 2025.4.1 or later, follow these steps, which are taken from the dj-stripe docs.
...
was added or removed (step 1, above). That might look something like this, using [Django signals](https://docs.djangoproject.com/en/stable/topics/signals/):
