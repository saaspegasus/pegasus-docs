...
<Aside title="Other configurations">
...
- To run Python without `uv` you'll need to follow the instructions for your own environment on
  [this page](/python/setup#using-native--system-python-with-virtual-environments-and-pip-tools).
</Aside>
...
Open a browser and visit [http://localhost:8000](http://localhost:8000) and you should see
your application!
...
The `make` quick start commands cover a lot for you.
