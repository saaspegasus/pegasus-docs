...
description: Enable asynchronous Django views and real-time websockets using Daphne, Uvicorn, and Django Channels for modern web applications.
---
...
as [outlined in the Django docs](https://docs.djangoproject.com/en/stable/howto/deployment/asgi/daphne/).
