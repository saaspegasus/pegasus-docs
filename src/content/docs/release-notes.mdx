...
This release upgrades Pegasus projects to Python 3.14, plus a few small improvements
to the upgrade workflow and a minor security cleanup.
...
If you're upgrading an existing project, bump your project's `requires-python` and
local Python version to 3.14 as part of the upgrade.
...
- Dropped support for `pip-tools` as a Python environment/package manager. All
  ...
  See the [pip-tools to uv migration guide](/cookbooks/#migrating-from-pip-tools-to-uv)
