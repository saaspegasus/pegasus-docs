...
See the [image generation documentation](/ai/images) for more details.
...
- Pinned the Postgres Docker image to version 17 everywhere.
...
- Fixed a missing return statement in the `get_discounted_price` billing utility.
