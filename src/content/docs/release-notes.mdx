...
This release introduces an optional change to how CSS classes work in Tailwind projects,
enhances the AI agent chat with a new streaming/thinking UI, adds a revamped sticky header,
