...
description: JavaScript design patterns for Pegasus projects including site-wide libraries, npm package integration, and SiteJS utility functions with Vite and Webpack.
sidebar:
  order: 2
---
