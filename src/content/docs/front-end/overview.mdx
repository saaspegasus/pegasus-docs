...
description: Modern JavaScript build pipeline with Vite or Webpack, TypeScript support, CSS compilation, and hybrid Django template integration architecture.
sidebar:
  order: 1
---
