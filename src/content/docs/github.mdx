...
If you're using the GitHub App, connect your repository first, then expand "Repo settings"
on the project download page and set the subdirectory there.
For other connection methods, click "Show Advanced Options" when adding the repository
and specify the subdirectory in the "Subdirectory" field.
