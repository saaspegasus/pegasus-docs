...
You can connect your Pegasus projects directly to GitHub instead of downloading them as a zip file.
...
**Make sure to set this before pushing your project for the first time.**
