---
title: Heroku
description: Deploy Pegasus apps to Heroku using Python buildpacks or Docker containers with PostgreSQL, Redis, and Celery for scalable web applications.
---
...
This will create the necessary files for the Heroku Python buildpack.
