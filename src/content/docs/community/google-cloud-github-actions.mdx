...
description: Automate Pegasus deployment to Google Cloud Run using GitHub Actions with service accounts, Artifact Registry, and CI/CD pipelines.
---

import { Aside, Steps } from '@astrojs/starlight/components';

<Aside type="note" title="Community Guide">
The following guide was contributed by Daan Vielen, a member of the Pegasus community.
Any questions or issues using it should be directed to the #deployment channel of the community Slack.
</Aside>
